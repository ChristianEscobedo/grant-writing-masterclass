...
function getSlideTitle(slideNumber: number): string {
  const slideTitles: Record<number, string> = {
    ...
    29: "Case Study: AI-Powered Success Story",
    ...
    51: "Client Acquisition Case Study #1",
    52: "Client Acquisition Case Study #2",
    ...
    82: "Success Stories & Case Studies",
...
function getSlideDescription(slideNumber: number): string {
  const slideDescriptions: Record<number, string> = {
    ...
    29: "Real-world case study showing how a grant writer used AI to increase productivity and success rates.",
    ...
    51: "Detailed case study of a successful client acquisition campaign for a new grant writing business.",
    52: "Second case study showing alternative client acquisition strategies for a different market segment.",
    ...
    82: "Detailed success stories and case studies of individuals who have built successful grant writing businesses.",
